...
metadataLNBA$Sample.Name <- factor(metadataLNBA$Sample.Name, levels= c("RISE509", "RK1001", "VLI092","KNK001","GEN72","GRS004","Gyvakaral1","I5884","GLZ002","GLZ001","KunilaII","VEL003","1343UNTAL85","HOP001", "HOP004","KLZ001","CHC004","6POST","KLE031","MIB054", "KLE048","OOH003","RISE505","ARS007","GRH001", "KZL002","I2470","RT5"))
...
ggsave(filename = "Figure1_Radiocarbondating_2021.pdf", plot = radiocarbon_plot, device = "pdf", path = "Plots/", height = 20, width = 35, units = "cm", limitsize = FALSE, bg = "transparent")
...
ss <- scale_size_area(breaks=c(1,5,10), max_size=8)

Map <- ggmap(map) + 
  geom_point(data=metadataLNBA, stroke=1, size = 5, aes(x=Longitude, y=Latitude, fill = Published, shape=Published)) + 
 ss +
 xlab("Latitude") + 
 ylab("Longitude") +
#  scale_fill_manual(values = c("#e7298aff","#66a61eff","#7570b3ff","#1b9e77ff","#d95f02ff")) +
  scale_fill_manual(values = c("#e7298aff","#e6ab02","#e6ab02","#e6ab02","#e6ab02")) +
